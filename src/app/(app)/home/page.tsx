    ...
    <div className="animate-fade-in">
      ...
      <div className="px-4 pt-2 pb-6 flex flex-col gap-6">
        ...
        <Link href="/flight" className="block">
          <div className="rounded-3xl p-5 text-white shadow-card-hover" style={{ background: "linear-gradient(135deg, #3D32CF, #5A51D8)" }}>
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-purple-200 text-xs font-medium uppercase tracking-wider">Active Flight</p>
            ...
            <div className="flex items-center gap-3">
              <div className="text-center">
                ...
                <p className="text-purple-200 text-xs mt-0.5">New York</p>
              </div>
              <div className="flex-1 flex flex-col items-center gap-1">
                ...
                <p className="text-purple-200 text-xs">5h 32m</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-black">LAX</p>
                <p className="text-purple-200 text-xs mt-0.5">Los Angeles</p>
              </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-white/20 flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-7 h-7 rounded-full bg-purple-300 border-2 border-white flex items-center justify-center text-purple-800 text-xs font-bold">
                      {String.fromCharCode(64 + i)}
                    </div>
                  ))}
                </div>
                <p className="text-purple-200 text-xs">12 connections nearby</p>
              </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              { href: "/network",       label: "Network",  color: "bg-brand-100 text-brand-600",        icon: "👥" },
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div key={person.name} className="card flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-brand-100 flex items-center justify-center text-sky-700 font-bold text-lg flex-shrink-0">
                  {person.name[0]}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-brand mt-0.5">{person.mutual} mutual connections</p>
                </div>
